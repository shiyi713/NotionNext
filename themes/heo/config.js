const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-10-23', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://yuanhang123.top' },
  ...
  HERO_TITLE_1: '分享红楼梦',
  HERO_TITLE_2: '与梦溪笔谈',
  HERO_TITLE_3: 'YUANHANG123.TOP',
  HERO_TITLE_4: '红楼梦',
  HERO_TITLE_5: '白茫茫大地真干净',
  HERO_TITLE_LINK: 'https://yuanhang123.top',
  ...
  INFO_CARD_URL: 'https://github.com/shiyi713/NotionNext', // 个人资料底部按钮链接
